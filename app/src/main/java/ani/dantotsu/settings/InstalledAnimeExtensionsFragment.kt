...
class InstalledAnimeExtensionsFragment : Fragment(), SearchQueryHandler {
    ...
    private val extensionsAdapter: AnimeExtensionsAdapter = AnimeExtensionsAdapter(
        onItemClicked = { pkg ->
    ...
    private class AnimeExtensionsAdapter(
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val hasSettings = extension.sources.filterIsInstance<ConfigurableAnimeSource>().isNotEmpty()
